...
cannon_game_grid = ButtonGrid(button_text_color, 250, -40, cannon_game_texts, main=True)
...
cannon_game_menu = GameMenu(cannon_game_grid, cannon_game_links, cannon_game_text, button_text_color, bg, 4,
                            game='Cannon')
